// Stubs for LogFormat/Data - QSOApiKeyQuery only needs AdiFormat's
// export/import round trip, not the full application. Mirrors
// tests/AdiFormatTest/test_stubs.cpp.
